...
import { CastEvent, CastMediaInfo, CastMediaStatus, PlayerState, RepeatMode, StreamType, MetadataType } from '../../../packages/nativescript-cast/types';

export class DemoSharedNativescriptCast extends DemoSharedBase {
  public cast: any;
  ...
  testIt() {
    console.log('test nativescript-cast!');
  }
}
